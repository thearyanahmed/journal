    ...
    <main class="w-full inline-block transition duration-500 ease-in-out overflow-y-scroll">
        <div class="mx-2 my-2">
            <div class="w-4/6 mx-auto">
                ...
                <form action="{{ route('articles.store') }}" method="POST" class="bg-gray-200 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" class="shadow appearance-none border rounded w-2/12 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
