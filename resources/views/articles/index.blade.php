            ...
            <main class="w-auto inline-block flex flex-1  flex-col transition duration-500 ease-in-out overflow-y-scroll">
                <div class="mx-2 my-2">
                    ...
                    <div class="articles-list">
                        <div class="bg-white mt-4 pb-4 rounded w-full">
                            @include('articles.table.head')
                            <div class="overflow-x-auto mt-6 rounded shadow-md">
                                <table id="articles-table" class="table-auto border-collapse w-full">
                                    ...
                                    <tbody class="text-sm font-normal text-gray-700">
                                        ...
                                        @else
                                            <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
                                                <td class="p-4" colspan="7">No articles found.</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
                            ...
                            @else
                                ...
                                @if($pageBuilder['has_filter'] === false)
